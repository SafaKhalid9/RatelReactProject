...
import ConfirmActions from "../../../components/DeleteAndCancelButtons";
import "../../../styles/ManhajDetails.css"; 

export default function ManhajDelete() {
  const handleDelete = () => alert("تم الضغط على حذف (تصميم فقط)");
  const handleCancel = () => alert("تم الضغط على إلغاء (تصميم فقط)");
  ...
  return (
    ...
    <div className="details-container">
      ...
      <div className="title-desigen">
        ...
        <div>
          <h2 className="delete-question">
            هل أنت متأكد من حذف منهج اللغة العربية؟
          </h2>
        </div>
      </div>
      ...
      <div className="Section">
        <div className="section-1">
          ...
          <div className="student-info-group">
            ...
            <a href="#" className="pdf-link" target="_blank" rel="noreferrer">
              📥 تحميل الملف
            </a>
          </div>
        </div>
      ...
      <ConfirmActions onDelete={handleDelete} onCancel={handleCancel} />
    </div>
    </>  
  );
}
