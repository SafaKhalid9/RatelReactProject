      ...
      <Table>
        <TableHeader className="bg-[#CB997E]">
          <TableRow>
            ...
            <TableHead className="text-center text-white font-bold py-4 px-14">اسم الحلقة</TableHead>
            <TableHead className="text-center text-white font-bold pl-14 py-4 w-[200px]">التحضير</TableHead>
          </TableRow>
        </TableHeader>
          ...
          {data.length === 0 ? (
            ...
            data.map((item, index) => (
              <TableRow key={index} className="font-semibold bg-white hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="text-center py-4 px-14">{item.halaqaName}</TableCell>
                <TableCell className="py-4 px-14">
