  ...
  return (
    <div className='flex flex-col gap-6 p-5'>
      <div className='flex justify-between items-center'>
        <CustomFormTitle title='Halaqas Management' subTitle='Manage your study groups' />
      ...
      {isError && <div className="text-center py-10 text-red-500">Error loading halaqas.</div>}
      
      {!isLoading && !isError && data && (
        <>
           <HalaqasTable data={data?.data || (Array.isArray(data) ? data : [])} />
