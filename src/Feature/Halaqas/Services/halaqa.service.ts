...
// import { BASE_URL, HALAQAS, USERS, MEMORIZATION_PATHS, MANHAJS } from '@/Constant/route';
// import { HalaqaListItem, HalaqaDetails, HalaqaFormData, HalaqaReviewParams } from '../Types/halaqa.types';
// import { MemorizationPath, Teacher, Manhaj } from '../Types/shared-dropdowns.types';
...
//   const response = await axios.get(`${BASE_URL}/${HALAQAS}`, { params: queryParams });
...
// const updateHalaqa = async ({ id, data }: { id: number; data: HalaqaFormData }) => {
