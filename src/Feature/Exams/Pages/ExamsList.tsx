...
const ExamsList = () => {
    ...
    const { data: responseData, isLoading, isError } = useExams({
      page,
      pageSize,
    });
    ...
    const exams = (responseData as any)?.data || (responseData as any)?.items || (Array.isArray(responseData) ? responseData : []);
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
