      ...
      <Card>
        <CardHeader className="bg-slate-50 dark:bg-slate-900 border-b">
          <div className="flex justify-between items-center">
            ...
            <Badge
              className={
                exam.examCategory === "Manhaj" ? "bg-primary" : "bg-secondary"
              }
            >
        ...
        <CardContent className="space-y-6 pt-6">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-lg font-medium">
                ...
                {new Date(exam.startDateTime).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </p>
              <p className="text-sm text-gray-400">
                إلى{" "}
                {new Date(exam.endDateTime).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </p>
          ...
          <div className="pt-5 flex gap-4 border-t mt-4">
            ...
            <Link to="/dashboard/exams">
              <CustomButton
                title="عودة للقائمة"
                className="w-32 bg-gray-500 hover:bg-gray-600"
                onClick={() => {}}
              />
            </Link>
          </div>
