...
import { useDeleteExam } from "../Services/exam.service";
...
const ExamActionsPopover: React.FC<ExamActionProps> = ({ id }) => {
...
export default ExamActionsPopover;
