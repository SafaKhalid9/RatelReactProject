  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (validate()) {
      ...
      const submissionData = {
        ...formData,
        manhajId:
          formData.examCategory === "Memorization" ? null : formData.manhajId,
      };
      ...
      <div className="flex justify-between gap-x-10">
        <label className="w-1/2">
          ...
          <Select
            ...
            onValueChange={(val) =>
              setFormData({ ...formData, examCategory: val as ExamCategory })
            }
          >
            <SelectTrigger>
        ...
        <label className="w-1/2">
          ...
          <Select
            ...
            onValueChange={(val) =>
              setFormData({ ...formData, halaqaId: Number(val) })
            }
          >
        ...
        <div className="flex justify-between gap-x-10">
          <label className="w-full">
            ...
            <Select
              ...
              onValueChange={(val) =>
                setFormData({ ...formData, manhajId: Number(val) })
              }
            >
              <SelectTrigger
                className={errors.manhajId ? "border-red-500" : ""}
              >
            ...
            {errors.manhajId && (
              <span className="text-red-500 text-sm">{errors.manhajId}</span>
            )}
          </label>
        </div>
      )}
      ...
      <div className="flex justify-between gap-x-10">
        <label className="w-1/2">
          ...
          <Select
            ...
            onValueChange={(val) =>
              setFormData({ ...formData, examTypeId: Number(val) })
            }
          >
            <SelectTrigger
              className={errors.examTypeId ? "border-red-500" : ""}
            >
          ...
          {errors.examTypeId && (
            <span className="text-red-500 text-sm">{errors.examTypeId}</span>
          )}
        </label>
        ...
        <label className="w-1/2">
          ...
          <Select
            ...
            onValueChange={(val) =>
              setFormData({ ...formData, userId: Number(val) })
            }
          >
      ...
      <div className="flex justify-between gap-x-10">
        <label className="w-1/3">
          ...
          {errors.startDateTime && (
            <span className="text-red-500 text-sm">{errors.startDateTime}</span>
          )}
        </label>
        ...
        <label className="w-1/3">
          ...
          />
          {errors.endDateTime && (
            <span className="text-red-500 text-sm">{errors.endDateTime}</span>
          )}
        </label>
        ...
        <label className="w-1/3">
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, examDegree: Number(e.target.value) })
            }
            className={errors.examDegree ? "border-red-500" : ""}
          />
          {errors.examDegree && (
            <span className="text-red-500 text-sm">{errors.examDegree}</span>
          )}
        </label>
      </div>
