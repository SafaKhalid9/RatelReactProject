...
//           <p className="p-3 rounded-md bg-gray-100 text-base">{halaqaName}</p>
//         </div>
//         <div className="flex flex-col gap-2">
//           <label className="font-semibold text-lg">اسم المنهج</label>
//           <p className="p-3 rounded-md bg-gray-100 text-base">{manhajName}</p>
//         </div>
//         <div className="flex flex-col gap-2">
...
//           <p className="p-3 rounded-md bg-gray-100 text-base min-h-[100px]">{notes}</p>
//         </div>
//       </div>
//     </div>
//   );
